...
require.register("bredele-brick-view/index.js", function(exports, require, module){
var Store = require('store'),
...
require.register("filters/index.js", function(exports, require, module){
//dependencies
...
module.exports = '<p>Let\'s start with the famous hello world! <a href="http://github.com/bredele/brick">brick</a> allows you to substitute variables into a template string or a dom element as following:</p>\n<pre><code class="lang-html">&lt;div class="brick"&gt;\n    &lt;style&gt;\n      .brick {\n          color: {{ color }};\n      }\n    &lt;/style&gt;\n    &lt;span class="brick"&gt;{{ label }}&lt;/span&gt;\n&lt;/div&gt;\n</code></pre>\n<p>Nothing more simple! </p>\n<pre><code class="lang-js">var view = brick(tmpl).build();\nview.set(\'label\', \'Hello!\');\n</code></pre>\n<blockquote>\n<p><strong>Tips</strong>: type <strong><code>hello color blue</code></strong> or <strong><code>hello label world</code></strong> in the console to update the demo!</p>\n</blockquote>\n';
});
...
module.exports = '<p>Let\'s stress the <code>Hello World!</code> demo a bit.\nIn this example, everytime you will type something it will update smoothly 1000 items in the same time.\nGo on, let\'s try it! </p>\n<p>Brick has been built for speed! In addition to be small, it includes memory safety and has a very low memory footprint.</p>';
});
require.register("computed/computed.html", function(exports, require, module){
module.exports = '<div class="computed">\n	<p>\n		This is an example by <a href="http://github.com/{{github}}/{{repo}}">{{github}}</a>\n	</p>\n	Please enter your <input type="text" value="{{firstName}}" model="firstName"> and your <input type="text" value="{{lastName}}" model="lastName">\n	Welcome <span>{{name}}</span>\n</div>';
});
require.register("computed/description.html", function(exports, require, module){
module.exports = '<p>In <a href="http://github.com/bredele/brick">brick</a> you can compute properties in two ways:</p>\n<pre><code class="lang-html">&lt;span&gt;{{ firstName + \' \' + lastName }}&lt;/span&gt;\n</code></pre>\n<p>or</p>\n<pre><code class="lang-js">view.compute(\'name\', function() {\n    return this.firstName + \' \' + this.lastName;\n});\n</code></pre>';
});
require.register("expressions/expressions.html", function(exports, require, module){
module.exports = '<span>The string <code>{{ label }}</code> has {{ label.length }} character{{ label.length > 1 ? \'s\' : \'\'}}</span>';
});
require.register("expressions/description.html", function(exports, require, module){
module.exports = '<p>Expressions in <a href="http://github.com/bredele/brick">brick</a> are a strict subset of the JavaScript language. You can use grouping, binary operators, identifiers, comparators and ternary operators, etc:\n</p>\n<p>Here\'s an example:</p>\n<pre><code class="lang-html"><span>The string {{label}} has {{ label.length }} character {{ label.length !== 1 ? \'s\' : \'\' }}</span>\n</code></pre>\n<p><strong>Tips</strong>: type <strong><code>expression smthg</code></strong> in the console to update the demo!</p>\n</blockquote>\n';
});
require.register("filters/filters.html", function(exports, require, module){
module.exports = '<div class="tmpl">\n	<input type="text" model="label" placeholder="Enter your name">\n	<span class="brick">{{ label } | uppercase | hello }</span>\n</div>\n';
});
require.register("filters/description.html", function(exports, require, module){
module.exports = '<p><a href="http://github.com/bredele/brick">Brick</a> allows you to apply filter(s) on your expressions:</p>\n<pre><code class="lang-html">&lt;span &gt;{{ label } | uppercase | hello}&lt;/span&gt;\n</code></pre>\n<p>just by doing: </p>\n<pre><code class="lang-js">view.filter(\'hello\', function(str) {\n return \'hello \' + str + \'!\';\n});\n</code></pre>\n<p>Filters and expressions are a convenient way to format your data. However, we advise you to keep your templates as clean as possible and to filter/compute/format your data programmaticaly : brick inherits from <a href="http://github.com/bredele/store">Store</a> which allows you to do all of that in JavaScript.</p>\n\n';
});
...
require.alias("bredele-artery/lib/app.js", "bredele-brick/deps/artery/lib/app.js");
require.alias("bredele-artery/index.js", "bredele-brick/deps/artery/index.js");
...
require.alias("bredele-brick-view/index.js", "bredele-brick/deps/brick-view/index.js");
require.alias("bredele-brick-view/index.js", "bredele-brick/deps/brick-view/index.js");
require.alias("bredele-binding/index.js", "bredele-brick-view/deps/binding/index.js");
require.alias("bredele-binding/index.js", "bredele-brick-view/deps/binding/index.js");
...
require.alias("bredele-store/index.js", "bredele-brick-view/deps/store/index.js");
require.alias("bredele-store/index.js", "bredele-brick-view/deps/store/index.js");
require.alias("component-emitter/index.js", "bredele-store/deps/emitter/index.js");
...
require.alias("bredele-clone/index.js", "bredele-clone/index.js");
require.alias("bredele-store/index.js", "bredele-store/index.js");
require.alias("bredele-each/index.js", "bredele-brick-view/deps/each/index.js");
require.alias("bredele-each/index.js", "bredele-brick-view/deps/each/index.js");
require.alias("bredele-each/index.js", "bredele-each/index.js");
require.alias("bredele-brick-view/index.js", "bredele-brick-view/index.js");
...
require.alias("hello/index.js", "home/deps/hello/index.js");
require.alias("bredele-brick/index.js", "hello/deps/brick/index.js");
require.alias("bredele-brick/index.js", "hello/deps/brick/index.js");
require.alias("bredele-artery/index.js", "bredele-brick/deps/artery/index.js");
require.alias("bredele-artery/lib/app.js", "bredele-brick/deps/artery/lib/app.js");
require.alias("bredele-artery/index.js", "bredele-brick/deps/artery/index.js");
...
require.alias("stress/index.js", "home/deps/stress/index.js");
require.alias("bredele-brick/index.js", "stress/deps/brick/index.js");
require.alias("bredele-brick/index.js", "stress/deps/brick/index.js");
require.alias("bredele-artery/index.js", "bredele-brick/deps/artery/index.js");
require.alias("bredele-artery/lib/app.js", "bredele-brick/deps/artery/lib/app.js");
require.alias("bredele-artery/index.js", "bredele-brick/deps/artery/index.js");
...
require.alias("computed/index.js", "home/deps/computed/index.js");
require.alias("bredele-brick/index.js", "computed/deps/brick/index.js");
require.alias("bredele-brick/index.js", "computed/deps/brick/index.js");
require.alias("bredele-artery/index.js", "bredele-brick/deps/artery/index.js");
require.alias("bredele-artery/lib/app.js", "bredele-brick/deps/artery/lib/app.js");
require.alias("bredele-artery/index.js", "bredele-brick/deps/artery/index.js");
...
require.alias("expressions/index.js", "home/deps/expressions/index.js");
require.alias("bredele-brick/index.js", "expressions/deps/brick/index.js");
require.alias("bredele-brick/index.js", "expressions/deps/brick/index.js");
require.alias("bredele-artery/index.js", "bredele-brick/deps/artery/index.js");
require.alias("bredele-artery/lib/app.js", "bredele-brick/deps/artery/lib/app.js");
require.alias("bredele-artery/index.js", "bredele-brick/deps/artery/index.js");
...
require.alias("filters/index.js", "home/deps/filters/index.js");
require.alias("filters/index.js", "home/deps/filters/index.js");
require.alias("bredele-brick/index.js", "filters/deps/brick/index.js");
require.alias("bredele-brick/index.js", "filters/deps/brick/index.js");
require.alias("bredele-artery/index.js", "bredele-brick/deps/artery/index.js");
require.alias("bredele-artery/lib/app.js", "bredele-brick/deps/artery/lib/app.js");
require.alias("bredele-artery/index.js", "bredele-brick/deps/artery/index.js");
...
require.alias("bredele-brick-view/index.js", "bredele-brick-view/index.js");
require.alias("bredele-brick/index.js", "bredele-brick/index.js");
require.alias("bredele-input-brick/index.js", "filters/deps/input-brick/index.js");
require.alias("bredele-input-brick/index.js", "filters/deps/input-brick/index.js");
require.alias("bredele-event/index.js", "bredele-input-brick/deps/event/index.js");
require.alias("bredele-event/index.js", "bredele-input-brick/deps/event/index.js");
require.alias("component-indexof/index.js", "bredele-event/deps/indexof/index.js");
...
require.alias("bredele-event/index.js", "bredele-event/index.js");
require.alias("bredele-input-brick/index.js", "bredele-input-brick/index.js");
require.alias("filters/index.js", "filters/index.js");
require.alias("todo/index.js", "home/deps/todo/index.js");
require.alias("todo/index.js", "home/deps/todo/index.js");
require.alias("bredele-brick/index.js", "todo/deps/brick/index.js");
require.alias("bredele-brick/index.js", "todo/deps/brick/index.js");
require.alias("bredele-artery/index.js", "bredele-brick/deps/artery/index.js");
require.alias("bredele-artery/lib/app.js", "bredele-brick/deps/artery/lib/app.js");
require.alias("bredele-artery/index.js", "bredele-brick/deps/artery/index.js");
...
require.alias("svg/index.js", "home/deps/svg/index.js");
require.alias("svg/index.js", "home/deps/svg/index.js");
require.alias("bredele-brick/index.js", "svg/deps/brick/index.js");
require.alias("bredele-brick/index.js", "svg/deps/brick/index.js");
require.alias("bredele-artery/index.js", "bredele-brick/deps/artery/index.js");
require.alias("bredele-artery/lib/app.js", "bredele-brick/deps/artery/lib/app.js");
require.alias("bredele-artery/index.js", "bredele-brick/deps/artery/index.js");
...
require.alias("bredele-brick-view/index.js", "bredele-brick-view/index.js");
require.alias("bredele-brick/index.js", "bredele-brick/index.js");
require.alias("bredele-input-brick/index.js", "svg/deps/input-brick/index.js");
require.alias("bredele-input-brick/index.js", "svg/deps/input-brick/index.js");
require.alias("bredele-event/index.js", "bredele-input-brick/deps/event/index.js");
require.alias("bredele-event/index.js", "bredele-input-brick/deps/event/index.js");
require.alias("component-indexof/index.js", "bredele-event/deps/indexof/index.js");
...
require.alias("console/index.js", "home/deps/console/index.js");
require.alias("bredele-brick/index.js", "console/deps/brick/index.js");
require.alias("bredele-brick/index.js", "console/deps/brick/index.js");
require.alias("bredele-artery/index.js", "bredele-brick/deps/artery/index.js");
require.alias("bredele-artery/lib/app.js", "bredele-brick/deps/artery/lib/app.js");
require.alias("bredele-artery/index.js", "bredele-brick/deps/artery/index.js");
